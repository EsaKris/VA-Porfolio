...
const WHATSAPP_NUMBER = "2347080397576"; // no +, no spaces

const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "okohaconfidence26@gmail.com",
    href: "mailto:okohaconfidence26@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+234 (0) 708 0397 576",
    href: "https://wa.me/2347080397576",
  },
  {
    icon: MapPin,
    label: "Location",
          ...
          <div className="space-y-6 animate-fade-in animation-delay-400">
            ...
            <div className="glass rounded-3xl p-8 border border-primary/30">
              ...
              <p className="text-muted-foreground text-sm">
                ...
                Whether you need a full-time assistant or a freelance partner,
                let's talk!
              </p>
            </div>
          </div>
